...
public partial class HitsoundCopierView : SingleRunMappingTool, ISavable<HitsoundCopierViewModel>
{
	...
	protected override void BackgroundWorker_DoWork(object? sender, DoWorkEventArgs e) {
        ...
        e.Result = Copy_Hitsounds((HitsoundCopierViewModel) e.Argument!, bgw!);
    }
	...
	protected override void BackgroundWorker_ProgressChanged(object? sender, ProgressChangedEventArgs e)
	{
		...
		HitsoundCopierViewModel.SetProgress(Progress);
    }

	private string Copy_Hitsounds(HitsoundCopierViewModel arg, BackgroundWorker worker) {
        ...
        foreach (var pathTo in paths) {
            BeatmapEditor editorTo = EditorReaderStuff.GetNewestVersionOrNot(pathTo);;
            Beatmap beatmapTo = editorTo.Beatmap;
            Beatmap beatmapFrom;
            if (!string.IsNullOrEmpty(arg.PathFrom)) {
                var editorFrom = EditorReaderStuff.GetNewestVersionOrNot(arg.PathFrom);
	...
	private static void CopyHitsounds(HitsoundCopierViewModel arg, Timeline tlFrom, Timeline tlTo) {
    ...
    private void CopyHitsounds(HitsoundCopierViewModel arg, double firstTime, Beatmap beatmapTo,
	...
	private static bool FilterMuteTlo(TimelineObject tloTo, Beatmap beatmapTo, HitsoundCopierViewModel arg) {
	...
	private static void CopyHitsounds(HitsoundCopierViewModel arg, TimelineObject tloFrom, TimelineObject tloTo) {
        // Copy to this tlo
